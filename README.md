...
An iMessage-native agent built with Photon iMessage Kit and Claude. You text it open loops — tasks, replies, things to do — and it follows up until you mark them done. No app to open, no dashboard to check. Just your existing Messages thread.
